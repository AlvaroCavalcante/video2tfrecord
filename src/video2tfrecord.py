...
def convert_videos_to_tfrecord(source_path, destination_path,
    ...
    for i, batch in enumerate(filenames_split):
        ...
        data, videos, triangle_data, bbox_positions, moviment_data, triangle_figures, labels, error_videos = video2numpy.convert_videos_to_numpy(filenames=batch, width=width, height=height,
        ...
        save_numpy_to_tfrecords(data, videos, triangle_data, bbox_positions, moviment_data, triangle_figures, batch, destination_path,
...
def save_numpy_to_tfrecords(data, videos, triangle_data, bbox_positions, moviment_data, triangle_figures, filenames, destination_path, fragment_size,
...
if __name__ == '__main__':
    convert_videos_to_tfrecord(
        '/home/alvaro/Downloads/CSL/color-gloss/color_train', 'results/train_v2',
        n_videos_in_record=250, width=512, height=512,
        label_path=None,
